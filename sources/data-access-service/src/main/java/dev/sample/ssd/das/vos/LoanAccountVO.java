...
//    	}
    	...
    	if( key == null ) {
    		if( this.opType == OperationType.updateLA ) {
    			this.mandatoryValidationMessage = this.mandatoryValidationMessage + "Rate of interest is not provided. ";
    		}
    		setRateOfInterest("");
    	}else {
...
//    	}
	...
	public JSONObject toJSON(){
		...
		jsonObject.put("approve_or_reject_date", this.approveOrRejectDate != null ? this.approveOrRejectDate.substring(0, 10):this.approveOrRejectDate);
